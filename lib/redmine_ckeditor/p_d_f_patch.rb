  ...
  module PDFPatch
    def self.included(base)
      base.class_eval do
        ...
        alias_method :formatted_text_without_ckeditor, :formatted_text
        alias_method :formatted_text, :formatted_text_with_ckeditor

        # alias_method_chain :get_image_filename, :ckeditor
        alias_method :RDMwriteHTMLCell_without_ckeditor, :RDMwriteHTMLCell
        alias_method :RDMwriteHTMLCell, :RDMwriteHTMLCell_with_ckeditor
